...
class JwtTokenProviderTest {
    ...
    private static final String TEST_SECRET = "testsecretkeytestsecretkey123456"; // 32+ chars
    ...
    void generateToken_Success() {
        ...
        Claims claims = Jwts.parserBuilder()
                .setSigningKey(Keys.hmacShaKeyFor(TEST_SECRET.getBytes(java.nio.charset.StandardCharsets.UTF_8)))
                .build()
