...
class BookingServiceEdgeCasesTest {
    ...
    void createBooking_ConcurrentBookings_SameSchedule() throws InterruptedException {
        ...
        // Assert
        assertEquals(1, successfulBookings.get(), "Should have exactly one successful booking");
        assertEquals(2, failedBookings.get(), "Should have exactly two failed bookings");
